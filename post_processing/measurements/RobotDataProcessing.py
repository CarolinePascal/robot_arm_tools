...
PWith[index].rfft(norm="forward").nth_oct_smooth_complex(octBand,fmin,fmax).filterout([fmin,fmax]).plot(axP,label="With robot")
PWithout[index].rfft(norm="forward").nth_oct_smooth_complex(octBand,fmin,fmax).filterout([fmin,fmax]).plot(axP,label="Without robot")
axP[0].set_xlim([fmin,fmax])
axP[1].set_xlim([fmin,fmax])
VWith[index].rfft().nth_oct_smooth_complex(octBand,fmin,fmax).filterout([fmin,fmax]).plot(axV,label="With robot")
VWithout[index].rfft().nth_oct_smooth_complex(octBand,fmin,fmax).filterout([fmin,fmax]).plot(axV,label="Without robot")
axV[0].set_xlim([fmin,fmax])
axV[1].set_xlim([fmin,fmax])

DeltaV = (VWith[index].rfft().nth_oct_smooth_complex(octBand,fmin,fmax).filterout([fmin,fmax])/VWithout[index].rfft().nth_oct_smooth_complex(octBand,fmin,fmax).filterout([fmin,fmax]))
DeltaP = (PWith[index].rfft().nth_oct_smooth_complex(octBand,fmin,fmax).filterout([fmin,fmax])/PWithout[index].rfft().nth_oct_smooth_complex(octBand,fmin,fmax).filterout([fmin,fmax]))
